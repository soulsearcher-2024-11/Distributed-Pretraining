...
def parse_args():
    ...
    p.add_argument("--tokenizer_name", type=str, default="../MandelbrotV1/26layers4/26_tokenizers", help="Tokenizer to use (default: gpt2)")
    ...
    # runtime
    p.add_argument("--output_dir", type=str, default="../MandelbrotV1/outputs_incremental_pretraining1", help="Output directory for checkpoints")
    ...
    p.add_argument("--model_name_or_path", type=str, default="../MandelbrotV1/configs/middle1", help="Path to pre-trained model or model identifier from huggingface.co/models")
