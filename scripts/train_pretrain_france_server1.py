...
def parse_args():
    ...
    # runtime
    p.add_argument("--output_dir", type=str, default="../MandelbrotV1/outputs_incremental_pretraining7", help="Output directory for checkpoints")
    ...
    p.add_argument("--distribution_Type", type=str, default="server", choices=["server", "client","middle_Server","local","incremental_pretrain_full","incremental_pretrain"], help="Distributed training type (is_Distribution=True Effective): server, middle_Server, clit Local training type (is_Distribution=False Effective): local, incremental_pretain_full, incremental_pretrain")
