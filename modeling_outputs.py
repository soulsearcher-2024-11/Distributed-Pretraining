...
@dataclass
class MandelbrotV1ModelOutput(BaseModelOutputWithPast):
    layer_idx: Optional[int] = None
    block_idx: Optional[int] = None
    mor_outputs: set[torch.FloatTensor] = None



@dataclass
class MandelbrotV1CausalLModelOutput(CausalLMOutputWithPast):
    layer_idx: Optional[int] = None
    block_idx: Optional[int] = None
    non_zero_count_loss: Optional[torch.FloatTensor] = None
    final_indep_loss: Optional[torch.FloatTensor] = None
    mor_outputs: set[torch.FloatTensor] = None
